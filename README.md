<div align="center">
  <img src="./logo.png" width="128" height="128" alt="PrimeWallet Logo" />
  <h1>PRIMEWALLET</h1>
  <p><strong>The primary gateway to the decentralized web</strong></p>
  ...
  [![Tech](https://img.shields.io/badge/stack-React%20%7C%20Tailwind%20%7C%20Web3.js-black.svg?style=for-the-badge)](https://0xtech.org)
</div>

---

<h2>Check Web3 Wallet</h2>
Live Demo: https://primewallet-demo.vercel.app/
<img src="./preview.png" alt="PrimeWallet Preview" />

## 🌌 Overview

PrimeWallet is a high-performance, web3 wallet platform engineered for professional traders and developers. By combining institutional-grade execution speed with a robust developer ecosystem, PrimeWallet provides the foundational layer for the primary gateway to the decentralized web.
...
PrimeWallet provides a comprehensive API surface for both frontend interactions and external integrations.

- **`/api/core/*`**: Direct interaction with PrimeWallet core features
...
<!-- Last Activity: 2026-02-11T16:11:14.844Z -->
